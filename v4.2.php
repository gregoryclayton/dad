...
$result = $conn->query("SELECT id, firstname, lastname, date, genre, country, bio, pp, fact1, fact2, fact3, link1, link2, link3, work1, work1link, work2, work2link, work3, work3link FROM users ORDER BY id DESC");
...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $jsonArray[] = [
            ...
            "work3" => $row["work3"],
            "work3link" => $row["work3link"], // No works from DB, so leave empty array
