...
<body>
  ...
  <div style="text-align:center; margin:2em 0 1em 0;">
    <input type="text" id="artistSearchBar" placeholder="Search artists..." style="width:300px; padding:0.6em 1em; font-size:1em; border-radius:7px; border:1px solid #ccc;">
  </div>

  <!-- SORT BUTTONS ADDED HERE -->
  <div style="text-align:center; margin:0 0 1.5em 0;">
    <button id="sortAlphaBtn" style="padding:0.7em 1.3em; font-size:1em; background:#2962ff; color:#fff; border:none; border-radius:8px; cursor:pointer; margin-right:0.6em;">
      Sort Alphabetically
    </button>
    <button id="sortDateBtn" style="padding:0.7em 1.3em; font-size:1em; background:#2962ff; color:#fff; border:none; border-radius:8px; cursor:pointer; margin-right:0.6em;">
      Sort by Date
    </button>
    <button id="sortCountryBtn" style="padding:0.7em 1.3em; font-size:1em; background:#2962ff; color:#fff; border:none; border-radius:8px; cursor:pointer;">
      Sort by Country
    </button>
  </div>
