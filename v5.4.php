  ...
  return folder.replace(/[^a-z0-9_\-]/g, '_');
    ...
    function renderArtist(index) {
      ...
      entry.innerHTML = `
        ...
        <span style="float:right; margin-left:24px;display:inline-flex;align-items:center;">
  <input type="radio" name="artist-radio" value="${index}" style="width:22px;height:22px;">
</span>
