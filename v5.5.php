...
<div style="display:flex;">
  <div class="title-container" id="mainTitleContainer">
   ...
   <div id="dotMenuContainer" style="position:relative; align-self:end; margin-bottom:50px;">
    <div id="dot" style="color:black;"></div>
    <div id="dotMenu" style="display:none; position:absolute; left:50%; top:110%; transform:translateX(-50%); background:white; border-radius:14px; box-shadow:0 4px 24px #0002; padding:1.4em 2em; min-width:120px; z-index:1000;">
