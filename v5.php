...
<div style="display:flex;">
  ...
  <div style="display:flex; align-content:center; justify-content:center;">
    <div class="nav-button" ><a href="">sign up</a></div><div class="nav-button"><a href="">contribute</a></div>
  </div>


<div class="container-container-container" style="display:grid; align-items:center; justify-items: center;"> 
<div class="container-container" style="border: double; border-radius:20px; padding-top:50px; width:90%; align-items:center; justify-items: center; display:grid; background: linear-gradient(180deg, #99a3d3 60%, #eebbc3 100%)">
